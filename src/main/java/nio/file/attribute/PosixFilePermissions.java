 ...
 * {@link PosixFilePermission} objects.这个类只包含对PosixFilePermission对象集进行操作的静态方法。
 *
 * @since 1.7
 */
...
public final class PosixFilePermissions {
    ...
    // Write string representation of permission bits to {@code sb}. 将权限位的字符串表示形式写入{@code sb}。
     ...
     * methods.通过调用createFile或createDirectory方法创建新文件或目录时可以自动设置的文件属性值的封装对象。
     *
     * @param   perms
     *          the set of permissions
     *
